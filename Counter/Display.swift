...
class Display: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        for sscIndex in 0...14 {
            drawSSC(context, sscRect:CGRectMake(xOrigin+CGFloat(sscIndex)*(bounds.size.width/15),yOrigin, bounds.size.width/15, segmentHeight), mask:segmentMasks[8])
        }
